...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/ws/lib/websocket.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/ws/lib/websocket.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/* eslint no-unused-vars: ["error", { "varsIgnorePattern": "^Readable$" }] */
